...
export function createWinterModelPrompt(outfit) {
  return `
...
export function createWinterFlatLayPrompt(outfit) {
  return `
...
export function createWinterPrompts(outfit) {
  return {
    model: createWinterModelPrompt(outfit),
    flatLay: createWinterFlatLayPrompt(outfit)
  };
}
