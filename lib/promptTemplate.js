...
Produktinformationen nedenfor skal bruges som reference til at identificere hvert produkt.

Uploadrækkefølgen er en hjælp, men den må ikke være den eneste måde at identificere produkterne på.

Brug både:

1. Det uploadede produktbillede.
2. Produktets navn.
3. Produktets kode.
4. Produktets visuelle kendetegn.
5. Produktets form, farve, motiv og karakteristiske detaljer.

til at afgøre hvilket fysisk produkt der hører til hvilken produktinformation.

Hvis et produktnavn tydeligt beskriver produktets visuelle udseende, skal denne information bruges til at kontrollere, at det rigtige fysiske produkt matches med det rigtige navn, den rigtige kode og den rigtige pris.

Eksempel:

Hvis produktnavnet er "Apple Squishy", skal produktet visuelt være det æbleformede produkt fra de uploadede billeder.

Hvis produktnavnet er "Strawberry Squishy", skal produktet visuelt være jordbærproduktet fra de uploadede billeder.

Hvis produktnavnet er "Bear Squishy", skal produktet visuelt være bjørneproduktet fra de uploadede billeder.

Dette eksempel er kun en forklaring på identifikationslogikken. Brug altid de faktiske produkter fra de uploadede billeder.

Hvis uploadrækkefølgen og produktets visuelle identitet ikke stemmer overens, skal produktets faktiske visuelle identitet bruges til at finde det korrekte match.

Rækkefølgen af de uploadede billeder er derfor en reference og ikke en absolut regel.

Hvis der er tydelige visuelle tegn på, at et produkt er blevet uploadet i en anden rækkefølge end produktinformationen, skal du korrigere matchingen ud fra produktets faktiske udseende.

Du må ikke ændre produktet for at få det til at passe med et navn.

Du må ikke ændre navnet for at få det til at passe med et forkert produkt.

Du skal matche det korrekte fysiske produkt med den korrekte produktinformation.

Når det korrekte match er identificeret, skal produktets navn, kode og pris følge dette produkt.

Brug kun produkter, der faktisk findes blandt de uploadede produktbilleder.

Du må aldrig opfinde et produkt, fordi et produkt mangler.

Du må aldrig vælge et produkt fra din egen viden eller fra andre billeder.
...
Fjern pladsholderen BILLEDE 1 og indsæt det produkt, der korrekt matcher Produkt 1.

Fjern pladsholderen BILLEDE 2 og indsæt det produkt, der korrekt matcher Produkt 2.

Fjern pladsholderen BILLEDE 3 og indsæt det produkt, der korrekt matcher Produkt 3.

Brug produktnavn, produktkode og produktets visuelle udseende til at sikre det korrekte match.

Hvis uploadrækkefølgen ikke passer med produktinformationen, skal du prioritere korrekt identifikation af det faktiske produkt frem for blindt at følge uploadrækkefølgen.
...
De tre vedhæftede produktbilleder repræsenterer de tre produkter, der skal bruges på forsiden.

Uploadrækkefølgen skal bruges som en reference til Produkt 1, Produkt 2 og Produkt 3.

Du skal samtidig kontrollere produkternes faktiske visuelle identitet.

Hvis uploadrækkefølgen ikke stemmer overens med produkternes faktiske visuelle identitet, skal du bruge produktets form, farve, motiv og øvrige visuelle kendetegn til at identificere det korrekte produkt.

Produktets visuelle identitet må ikke ændres for at passe til rækkefølgen.

Brug altid de faktiske produkter fra de tre uploadede billeder.

Hvis et produkt tydeligt kan identificeres ud fra form, farve, motiv eller andre visuelle kendetegn, skal denne identifikation prioriteres frem for en fejl i uploadrækkefølgen.

Det første identificerede produkt skal behandles som Produkt 1.

Det andet identificerede produkt skal behandles som Produkt 2.

Det tredje identificerede produkt skal behandles som Produkt 3.

Brug aldrig et andet produkt end de tre uploadede produkter.
