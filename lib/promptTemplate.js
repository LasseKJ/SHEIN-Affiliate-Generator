...
P1-ProduktNavn-ProduktKode.jpg

Eksempel:

P1-Butter-HDK23D.jpg
...
Hvis filen med navnet P1-Butter-HDK23D.jpg bliver uploadet som det tredje billede, skal den stadig behandles som Produkt 1.

Hvis filen med navnet P2-Apple-ABC45F.jpg bliver uploadet som det første billede, skal den stadig behandles som Produkt 2.
...
Hvis P1-Butter-HDK23D.jpg eksempelvis bliver uploadet som det tredje billede, er det stadig Produkt 1.
...
function createProductFilename(
  ...
  return `P${productNumber}-${productName}-${productCode}.jpg`;
}
