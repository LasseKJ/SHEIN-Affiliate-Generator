...
For every product, display two text lines directly above the product.

The first line is the product name from the Google Sheet.
...
The only text in the image should be the six product names and the six exact product codes.
